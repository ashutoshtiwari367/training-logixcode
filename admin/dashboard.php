      ...
      <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
        ...
        <td class="px-6 py-4 text-right flex items-center justify-end gap-2">
          ...
          <?php
            ...
            $formUrl = 'https://training.logixcode.com/student-enquiry.php';
            $waMsg = urlencode(
                "Namaste " . $reg['first_name'] . " ji! 🙏\n" .
                "LogixCode IT Solution mein aapka swagat hai.\n\n" .
                "Please apni puri details bharne ke liye neeche diye link par click karein:\n" .
                $formUrl . "\n\n" .
                "Koi bhi sawal ho toh humse sampark karein. 😊"
            );
          ?>
          <a href="https://wa.me/<?= $waPhone ?>?text=<?= $waMsg ?>" target="_blank"
             class="text-slate-400 hover:text-green-500 p-1.5" title="Send WhatsApp Form Link">
